...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full bg-white shadow-md px-6 py-2 flex justify-between items-center
        z-5">
        ...
        <div className="hidden md:flex items-center space-x-6 text-sm font-medium">
          {
            isAuth && (
              <div className="flex justify-centSer items-center mr-80 gap-15 md:mr-10 md:gap-10">
                <Link to="/"> Home </Link>
      ...
      <div
        className={`fixed top-0 left-0 h-full w-full bg-white shadow-lg z-50 transform transition-transform 
        duration-300 text-center space-y-6
