      ...
      <div className="w-full max-w-lg rounded-[32px] bg-white p-10 shadow-2xl mt-20">
        ...
        <div className="mt-8 space-y-4">
          ...
          <form className="space-y-6" onSubmit={Handle_Login_Submit}>
            <div>
              ...
              <div className="flex items-center gap-3 rounded-3xl border border-slate-300 bg-slate-50 px-4 
                ...
                <input type="email" placeholder="Enter your email address..." className="w-full bg-transparent
                 text-slate-900 outline-none" required />
              </div>
            </div>
            ...
            <button className="w-[200px] lg:ml-30 ml-10 mt-4 rounded-3xl cursor-pointer bg-gradient-to-r from-blue-600 to-violet-600 py-3 text-white text-sm font-semibold shadow-lg transition hover:opacity-95">
              Log In
            </button>
          </form>
        </div>
